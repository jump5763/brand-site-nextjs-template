...
async function main() {
  ...
  if (!entries.length) throw new Error("SECTIONS_EMPTY");
  ...
  ajv().compile(schema);
  const types = await compile(schema, "SiteDocument", {
